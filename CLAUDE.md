...
Before implementing:
- Always read the global rules (`global_rules`) in `cahier_des_charges.yaml` before planning or writing code.
...
**Toute modification de code ou ajout de fonctionnalité doit s'accompagner d'une mise à jour de la documentation.**
